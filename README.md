# Hydro-Game-Engine
Hydro is a SUPER BASIC game engine created by me, Harol, just for fun. It’s written in Odin and uses OpenGL. I developed this engine between 8th and 9th grade.

![Image](https://github.com/user-attachments/assets/96c19de6-4e3e-4cfb-beb3-27cb0f9a2f73)

# Why i'm doing this?
- I made this SUPER BASIC game engine cause i what to enter a good university & wanted to show my abilities to get in.
- I always wanted to do a game engine, they are so wierd to understand.
- I wanted to know if was capable to making it.

# What i learned from this:
- Making a game engine more complicated than you think
- I hate making game engine
- I never want to do another again (maybe if i get support yes)
